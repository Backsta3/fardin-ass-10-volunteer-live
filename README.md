...
This is an volunteer service web app like an event management web app.
## Used App:
React, JavaScript(ES6), MongoDB, React-Router, Material UI, Firebase, Html, CSS
## Features
Different panel for user and admin Panel and adding Event Option for an admin. Fully responsive with sign-in/up feature.
## Live Link: https://fardin-volunteer.web.app/
<br />
<br />
